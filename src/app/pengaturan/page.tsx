...
import { Settings, Save, Download, Upload, RotateCcw, Building2, Check, AlertTriangle } from 'lucide-react';
    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div>
        <h1 className="text-2xl font-extrabold text-white tracking-tight flex items-center gap-2">
          ...
          Pengaturan Pesantren & Backup Database
        </h1>
        <p className="text-xs text-slate-400">
          Ubah nama pondok pesantren, identitas Kop Surat Izin, serta backup & restore database JSON
        </p>
      </div>
